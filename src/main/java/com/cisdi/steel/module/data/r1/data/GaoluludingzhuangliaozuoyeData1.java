 ...
 */
@Component
public class GaoluludingzhuangliaozuoyeData1 extends AbstractGlDataExecute {
    @Override
    ...
    public Map<String, Object> getDetail() {
        Map<String, Object> map = new HashMap<>();
        map.put("code", RandomStringUtils.randomAlphabetic(5));
        map.put("weightset", RandomStringUtils.randomNumeric(4));
        map.put("weightdry", RandomStringUtils.randomNumeric(4));
        map.put("weightwet", RandomStringUtils.randomNumeric(4));
        map.put("moisture", RandomUtils.nextInt(1, 11));
        return map;
    }
