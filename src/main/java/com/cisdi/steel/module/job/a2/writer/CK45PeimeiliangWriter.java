 ...
 */
@Component
public class CK45PeimeiliangWriter extends AbstractExcelReadWriter {
            ...
            if (StringUtils.isNotBlank(result)) {
                ...
                if (Objects.nonNull(jsonObject2)) {
                    ...
                    for (int j = 0; j < nameList.size(); j++) {
                        ...
                        Double val = 0.0;
                        String tagName = rowCelVal.get(0);
...
//                        valList.add(val);
            ...
            List<CellData> cellDataList1 = handlerRowData(columns, rowIndex, rowData);
            String hour = DateUtil.getFormatDateTime(DateUtil.strToDate(clock, DateUtil.fullFormat), "HH");
    ...
    protected Map<String, String> getQueryParam1(DateQuery dateQuery, String version) {
        ...
        String tagName = "CK67_L1R_CB_CBReset_4_report";
        if ("45.0".equals(version)) {
            tagName = "CK45_L1R_CB_CBReset_4_report";
        }
