...
public enum JobEnum {
    ...
    gl_kaoheyuebao("gl_kaoheyuebao","8高炉考核月报表"),
    gl_jishujingji("gl_jishujingji","8高炉技术经济月报表"),
    gl_caozuoguanliriji("gl_caozuoguanliriji","8高炉操作管理日记"),
    ...
    gl_caozuoguanliriji7("gl_caozuoguanliriji7","7高炉操作管理日记"),
    gl_yuebaohuizong7("gl_yuebaohuizong7","7高炉月报汇总"),
    gl_luwenhegelv7("gl_luwenhegelv7","7高炉炉温合格率精益统计表"),
    gl_tieshuiyijipinlv7("gl_tieshuiyijipinlv7","7高炉铁水一级品率精益统计表"),
    gl_luzhajianduhegelv7("gl_luzhajianduhegelv7","7高炉炉渣碱度合格率精益统计表"),
    ...
    gl_jixiejiankong7("gl_jixiejiankong7", "7高炉TRT机械监控表"),
    gl_gongyinenghaotongJi7("gl_gongyinenghaotongJi7", "7高炉TRT工艺能耗统计表"),
    // 焦化te
...
//    jh_jiaolujiare5("jh_jiaolujiare5", "炼焦-5#焦炉加热制度报表（日）"),
    ...
    sj_meizhouchanliangfenxi("sj_meizhouchanliangfenxi", "4烧结每周产量分析"),
    sj_shengchanfenxizhoubao("sj_shengchanfenxizhoubao", "4烧结生产分析周报"),
