...
//                        valList.add(val);
    ...
    protected String getUrl() {
        return httpProperties.getUrlApiJHTwo() + "/jhTagValue/getCoalSiloName";
    }

    protected String getUrl2() {
        return httpProperties.getUrlApiJHTwo() + "/manufacturingState/getTagValue";
    }

    protected String getUrl3() {
        return httpProperties.getUrlApiJHTwo() + "/coalBlendingStatus/getVauleByNameAndTime";
    }
}
