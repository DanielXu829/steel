...
import com.cisdi.steel.module.data.r2.data.HuachanData;
 ...
 */
@Component
public class JobHuachan extends AbstractJob {
    @Override
    protected void init() {
        this.dataHandler = ApplicationContextHolder.getBean(HuachanData.class);
    }
