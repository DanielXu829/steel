...
import com.cisdi.steel.module.data.r1.data.GaowenlengquebiwenduData2;
 ...
 */
@Component
public class Gaowenlengquebiwendu2 extends AbstractJob {

    @Override
    protected void init() {
        this.dataHandler = ApplicationContextHolder.getBean(GaowenlengquebiwenduData2.class);
    }
