...
public class DemoController {
    ...
    @RequestMapping(value = "/pageoffice/index", produces = {"text/plain;charset=UTF-8"})
    ...
    @RequestMapping(value = "/pageoffice/edit", produces = {"text/plain;charset=UTF-8"})
    public ModelAndView showWord(HttpServletRequest request, Map<String, Object> map) throws Exception {
        ...
        poCtrl.setSaveFilePage("/pageoffice/save?filePath=" + filePath);//设置处理文件保存的请求方法
        //打开指定目录下的office
...
//        File file = new File("e://test.xlsx");
    ...
    @RequestMapping(value = "/pageoffice/save", produces = {"text/plain;charset=UTF-8"})
