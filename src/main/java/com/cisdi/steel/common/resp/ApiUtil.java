...
public class ApiUtil {
     ...
     * @return 结果
     */
    public static <T> ApiPageResult<T> successPage(long total,T data){
        return buildPage(HttpCodeEnum.OK, total, data);
    }
    /**
     * 请求成功
     *
     ...
     * @return 结果
     */
    private static <T> ApiPageResult<T> buildPage(HttpCodeEnum httpCodeEnum,long total,T data){
        ApiPageResult<T> apiPageResult = new ApiPageResult();
        apiPageResult.setTotal(total);
        apiPageResult.setData(data);
        apiPageResult.setCode(httpCodeEnum.getCode());
        apiPageResult.setMsg(httpCodeEnum.getMsg());
