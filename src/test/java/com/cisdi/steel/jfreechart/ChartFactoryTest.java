...
//				categoryAxisLabel, valueAxisLabel, series, categories);
//		File file = new File("D:\\lineChart.jpeg");
//		int width = 1024;
//		int height = 420;
//		ChartUtilities.saveChartAsJPEG(file, chart, width, height);
    }
    ...
    @Test
    public void testCreatePolarChart() throws Exception {
        String title = "第6段";
        String categoryAxisLabel = "";
        String valueAxisLabel = "";
        JFreeChart chart = ChartFactory.createPolarChart(title, categoryAxisLabel, valueAxisLabel, ChartDataSet.createXYSeriesCollection());
        File file = new File("D:\\lineChart1.jpeg");
        int width = 1024;
        int height = 420;
        ChartUtilities.saveChartAsJPEG(file, chart, width, height);
    }
    ...
    @Test
    public void testCreateSpiderChart() throws Exception {
