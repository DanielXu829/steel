...
public class TestJob2 extends SteelApplicationTests {
     ...
     */
    @Autowired
    private CK12ZidongpeimeiNewJob ck12ZidongpeimeiNewJob;

    @Test
    public void test6666() {
        ck12ZidongpeimeiNewJob.execute(null);
    }
     ...
     */
    @Autowired
    private CK45ZidongpeimeiJob ck45ZidongpeimeiJob;

    @Test
    public void test666() {
        ck45ZidongpeimeiJob.execute(null);
    }
