...
//            System.out.println(reportIndex.getPath());
    ...
    public void test3224() {
        createTask(JobEnum.nj_jiepailing_day.getCode(), jobGroup, "0 2 0/1 * * ?", "");
        createTask(JobEnum.nj_gongluyinsutongji_month.getCode(), jobGroup, "0 2 0/1 * * ?", "");
        createTask(JobEnum.nj_jidu_year.getCode(), jobGroup, "0 2 0/1 * * ?", "");
    }
    ...
    public void test32() throws SchedulerException {
        JobKey key = new JobKey(JobEnum.hb_meiqichuchen7bf.getCode(), jobGroup);
    ...
    public void test3333() {
        JobKey jobKey = JobKey.jobKey(JobEnum.gl_gaolupenmei7.getCode(), jobGroup);
        try {
            scheduler.deleteJob(jobKey);
        } catch (SchedulerException e) {
            e.printStackTrace();
