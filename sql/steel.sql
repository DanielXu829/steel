...
-- ----------------------------
INSERT INTO `QRTZ_TRIGGERS` VALUES ('schedulerFactoryBean', 'triggertest', '高炉', 'test', '高炉', NULL, 1557799740000, 1557799680000, 5, 'WAITING', 'CRON', 1542609734000, 0, NULL, 0, '');
...
CREATE TABLE `report_category_template`  (
  ...
  `attr5` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 220 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分类模板配置' ROW_FORMAT = Compact;
...
INSERT INTO `report_category_template` VALUES (148, 'jh_luwenguankong', '焦化', '炼焦-炉温管控', 'D:\\template\\焦化\\焦炉炉温管控.xlsx', 'report_month', 'cn_zh', NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL, '1', NULL, NULL, NULL, NULL);
...
CREATE TABLE `report_index`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8851 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '报表文件-索引' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of report_index
-- ----------------------------
INSERT INTO `report_index` VALUES (8849, 'jh_zhuanyunzhanchuchen', '焦化12', 'CK12-干熄焦-转运站除尘报表（日）_2019-05-14_11.xlsx', 'D:\\excel\\cn_zh\\焦化12\\日报表\\CK12-干熄焦-转运站除尘报表（日）_2019-05-14_11.xlsx', '2019-05-14 10:04:53', '2019-05-14 10:09:19', NULL, 'report_day', 'cn_zh', '0', NULL, NULL, NULL, NULL, '2019-05-14 10:09:15');
INSERT INTO `report_index` VALUES (8850, 'jh_quyangchuchen', '焦化12', 'CK12-干熄焦-取样除尘报表（日）_2019-05-14_11.xlsx', 'D:\\excel\\cn_zh\\焦化12\\日报表\\CK12-干熄焦-取样除尘报表（日）_2019-05-14_11.xlsx', '2019-05-14 10:10:15', '2019-05-14 10:10:15', NULL, 'report_day', 'cn_zh', '0', NULL, NULL, NULL, NULL, '2019-05-14 10:10:12');
